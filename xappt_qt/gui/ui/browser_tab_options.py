...
# Form implementation generated from reading ui file '/home/cmontesano/projects/xappt_qt/resources/ui/browser_tab_options.ui'
#
...
class Ui_tabOptions(object):
    def setupUi(self, tabOptions):
        ...
        self.gridLayout_3.addWidget(self.chkStartMinimized, 1, 0, 1, 1)
        self.chkMinimizeToTray = QtWidgets.QCheckBox(tabOptions)
        self.chkMinimizeToTray.setObjectName("chkMinimizeToTray")
        self.gridLayout_3.addWidget(self.chkMinimizeToTray, 0, 0, 1, 1)
